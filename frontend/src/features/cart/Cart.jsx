...
function Cart() {
  ...
  return (
    <section className="py-10 sm:py-16 md:py-20 animate-fade-in-up">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[1.6fr_0.7fr]">
          ...
          <div className="min-w-0">
            <div className="rounded-xl shadow-sm border border-gray-200 bg-white p-4 sm:p-5 lg:sticky lg:top-24">
